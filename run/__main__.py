...
parser.add_argument('-t', dest='epochs', type=int, help='The number of training epochs (8192 Steps).', default=25) #25->200k, 128->1M
...
timesteps = args.pop('epochs') * 2048 * 4 
...
model.learn(total_timesteps=timesteps, eval_kwargs={'write_heatmaps': 'Fetch' not in args['envs'][0]})
