...
from direct import DIRECT; from baselines import PPO; 
...
parser.add_argument('--chi', type=float, help='The mixture parameter determining the mixture of real and discriminative reward. (default: 1.0)')
parser.add_argument('--kappa', type=int, help='Number of trajectories to be stored in the direct buffer. (default: 512)')
parser.add_argument('--omega', type=float, help='The frequency to perform discriminator updates in relation to policy updates. (default: 1/1)')
...
base_path = lambda seed: f"results/{algorithm.__name__}/{env['name']}/{seed}/"
...
args = {'envs': envs, 'path': path, 'seed': seed, **args, 'n_steps': 64}
